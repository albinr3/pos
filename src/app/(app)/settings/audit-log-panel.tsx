...
const ACTION_LABELS: Record<(typeof AUDIT_ACTIONS)[number], string> = {
  ...
  PASSWORD_RESET_REQUESTED: "Solicitud de código temporal",
  PASSWORD_RESET_COMPLETED: "Ingreso con código temporal",
  ...
  TREASURY_TRANSFER_CREATED: "Transferencia de tesorería creada",
  TREASURY_TRANSFER_REVERSED: "Transferencia de tesorería reversada",
